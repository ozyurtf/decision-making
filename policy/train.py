...
class WorkspaceIL:
	def __init__(self, cfg):
		...
		self.agent = make_agent(self.env.observation_spec(), self.env.action_spec(), cfg.agent)

		self.expert_replay_loader = make_expert_replay_loader(self.cfg.expert_dataset, 
                                                        	  self.cfg.batch_size, 
                                                           	  self.cfg.obs_type, 
                                                              self.cfg.suite.height, 
                                                              self.cfg.suite.width, 
                                                              self.cfg.train_test_ratio)
